...
@php
  ...
  $jabatanPejabat = $jabatanPejabat ?? 'Pembimbing Lapangan';

  $namaPejabat =
    $namaPejabat
    ?? optional(optional($penilaian)->supervisor)->name
    ?? ($penilaian->supervisor_nama ?? null)
    ?? ($penilaian->nama_supervisor ?? null)
    ?? optional(optional($penilaian)->pembimbing)->name
    ?? optional(optional($penilaian)->user)->name
    ?? 'Supervisor';

  $nipPejabat =
    $nipPejabat
    ?? optional(optional($penilaian)->supervisor)->nip
    ?? ($penilaian->supervisor_nip ?? null)
    ?? ($penilaian->nip_supervisor ?? null)
    ?? optional(optional($penilaian)->pembimbing)->nip
    ?? optional(optional($penilaian)->user)->nip
    ?? '-';
@endphp
  ...
  <div class="content">
    ...
    <div class="ttd">
      <div class="ttd-right">
        ...
        <div class="jabatan">{{ $jabatanPejabat }}</div>
        <div class="nama">{{ $namaPejabat }}</div>
        <div class="nip">NIP. {{ $nipPejabat }}</div>
      </div>
    </div>

    <div class="foot">Dokumen ini dicetak otomatis melalui sistem.</div>
